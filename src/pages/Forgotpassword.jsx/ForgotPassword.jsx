...
export default function ForgotPassword() {
    ...
    const handleSendOTP = async () => {
      ...
      try {
        const response = await axios.post("https://api.kameti.pk/api/sendCode", payload);
    ...
    const handleResetPassword = async () => {
      ...
      try {
        const response = await axios.post("https://api.kameti.pk/api/resetPassword", {
          phoneNumber: email, // Make sure this matches API requirements
